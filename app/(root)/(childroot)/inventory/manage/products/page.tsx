          ...
          <div className="px-3 py-4 flex justify-between items-center ">
            <div className="flex items-center gap-x-3">
              <input
                ...
                className=" px-1 py-3 w-72 text-sm rounded-md focus:outline-none bg-white"
              />
                  ...
                  <div className="space-y-5">
                    {dataList.map((elem: DataListInterface, index) => {
                      ...
                      return (
                        <div
                          key={index}
                          className={`hover:bg-[#d0d0d0] flex items-center flex-1 text-base py-5 border-b-2 border-b-[#E4E4E7]`}
                        >
