      ...
      return (
        <div className="space-x-4">
          <Action_Button
            ...
            bg_color={getDataArchiveType ? "bg-green-400" : "bg-[#FF6363]"}
          />
    ...
    <main className="w-full  h-full font-[500] text-[20px]">
            ...
            <div className="space-y-1">
              <div className="flex items-center w-full justify-between gap-x-3">
                <input
                  ...
                  className=" block px-1 py-3 w-72 text-sm rounded-md focus:outline-none bg-white"
                />
                <button
                  className="block"
                  onClick={() => openModalHandle(modalStateEnum.CREATE)}
                >
                  <Image className="w-9" src={PlusIcon} alt="Logo" />
                </button>
              </div>
            </div>
            ...
            <div className="pb-3 flex text-base text-[#71717A] items-center flex-1 font-normal border-b-2 border-b-[#E4E4E7]">
              {tableHeader.map(({ label, align }, index) => {
                return (
                  <h1
                    key={index}
                    className={`flex-1 ${align || "text-start"}  `}
                  >
                    {label}
                  </h1>
                );
                  ...
                  <div className="space-y-5">
                    {dataList.map((elem: DataListInterface, index) => {
                      ...
                      return (
                        <div
                          key={index}
                          className={`hover:bg-[#d0d0d0] flex items-center flex-1 text-base border-b-2 border-b-[#E4E4E7]  px-3 py-4 rounded-md`}
                        >
                          {tableHeader.map(
      ...
      >
        <Input_Component
          ...
          onChange={(e: any) => modalInputChangeHandle("category_name", e)}
          py="py-3"
