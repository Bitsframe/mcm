...
const CartItemComponent: FC<CartItemComponentInterface> = ({
  ...
  return (
    <div className="bg-[#AFB8C6] py-2 px-3 rounded-lg">
        ...
        <div className="bg-[#B8C8E1] h-[100%]  col-span-2 rounded-md py-2   ">
          <span>
            <div className="space-y-6 px-3 py-4">
              <h1 className="text-xl font-bold">Patients Details</h1>
              {fetchingDataLoading ? (
                  ...
                  {selectedPatient ? (
                    render_details.map(({ label, key, render_value }, ind) => {
                      const extracted_val = render_value
                        ...
                        : selectedPatient[key];
                      return (
                        <dl key={ind} className="grid grid-cols-4 space-x-5">
                          <dt>{label}</dt>
              ...
              <div className="space-y-6">
                ...
                <div className="flex">
                  <button
                    ...
                    className="bg-[#8CB3F0] text-[#fff] font-bold py-3 px-9 rounded-md hover:opacity-80 active:opacity-50 disabled:opacity-60"
                    type="submit"
                  >
                    Add to cart
                  </button>
        ...
        <div className="bg-[#B8C8E1] h-[100%] rounded-md overflow-hidden flex flex-col">
          ...
          <div className="bg-[#FFFFFF80]">
            <div className="py-3 px-4 border-t-[1px] border-t-[#817B7B] space-y-3">
              ...
              />
              <div className="flex items-center">
                <h1 className="text-lg flex-1">Payment method</h1>
            ...
            <div className="py-3 px-4 border-t-[1px] border-t-[#817B7B] space-y-3">
              ...
              <div className="flex items-center">
                <h1 className="text-lg flex-1">Sub total</h1>
                <div className="flex items-center space-x-1">
              ...
              <div className={`flex justify-end `}>
                <button
                  ...
                  className="bg-[#11252C] w-44 py-1 px-3 text-white rounded-md disabled:opacity-75"
                >
                  {placeOrderLoading ? (
