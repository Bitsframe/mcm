...
import { delete_content_service } from '@/utils/supabase/data_services/data_services';
...
export async function POST(request: Request) {
  try {
    ...
    // 2) sales_history where order_id = X
    ...
    // 3) transaction_history where order_id = X (remove transaction records first to avoid FK failures)
