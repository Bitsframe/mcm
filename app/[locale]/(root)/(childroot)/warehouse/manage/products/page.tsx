              ...
              return id === "category_id" ? (
                ...
                <div key={index} className={colSpan || "col-span-2"}>
                  ...
                  <input
                    ...
                    min="0"
                    step="1"
                    value={modalData[id] || 0}
                    onChange={(e) => modalInputChangeHandle(id, e.target.value)}
                    disabled={modalData.unlimited}
                    className="w-full px-3 py-2 border border-gray-300 rounded-md bg-[#f1f4f9] dark:bg-[#122136] dark:border-gray-600 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed"
                  />
                </div>
              ) : (
                <div key={index} className={colSpan || "col-span-2"}>
