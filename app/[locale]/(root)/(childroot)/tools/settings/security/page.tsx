  ...
  <div className="bg-white rounded-lg border border-gray-200 shadow-sm">
    ...
    <div className="p-4">
      <form onSubmit={handleSubmit}>
        <div className="mb-6">
          <h2 className="mb-4 text-callout font-semibold text-label">
            {t("Settings_k12")}
          </h2>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
                  <label className="text-footnote text-label-2">{t("Settings_k14")}</label>
              <div className="relative">
                <input
                  ...
                  className="w-full p-2 pr-8 text-sm border border-gray-300 rounded bg-[#F5F5F7]"
                  placeholder="••••••••"
                />
                <button
                  type="button"
            ...
            <div className="space-y-2">
              <label className="text-xs text-gray-500">{t("Settings_k15")}</label>
              <div className="relative">
                <input
        ...
        <div className="flex justify-start mt-6">
          <div className="flex items-center gap-3">
            <button
              type="button"
              onClick={handleReset}
              className="px-6 py-2 text-red-500 bg-red-100 rounded-lg text-sm hover:bg-red-200 transition-colors"
            >
              {t("Settings_k9")}
            </button>
            <Button
              type="submit"
              className="bg-[#166534] hover:bg-brand-600 px-5 text-sm rounded-lg"
            >
              {t("Settings_k17")}
            </Button>
          </div>
