  ...
  <>
    <div style={container}>
      ...
      <Text style={paragraph}>
        🍂October is the month to fight breast cancer! 💝Protect yourself! At
        Clínica San Miguel we give you the mammogram order for only ${price}.
        Don&#39;t wait any longer! It is without appointment.
      </Text>
