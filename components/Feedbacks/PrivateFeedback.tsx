...
const detailsArray = (dataDetails: DataListInterface) => [
  ...
  {
    label: "Feedback Date",
    value: moment(dataDetails?.created_at, "YYYY-MM-DD h:mm s").format(
      "MMM DD, YYYY"
    ),
  },
  {
    ...
    <main className="w-full  h-full font-[500] text-[20px]">
      ...
      <div className="w-full min-h-[80.5dvh] h-[100%] py-2 px-2 grid grid-cols-3 gap-2">
                ...
                dataList.map((elem) => {
                  ...
                  return (
                    <div
                      ...
                      className="cursor-pointer hover:bg-gray-500 hover:text-white flex items-center flex-1 font-semibold bg-white px-3 py-4 rounded-md "
                    >
                      <h1 className="flex-1 text-start">
                        {firstname} {lastname}
                      </h1>
                      <h1 className="flex-1 text-center">{order_id}</h1>
                      <h1 className="flex-1 text-center">
                        {moment(created_at, "YYYY-MM-DD h:mm s").format(
                          "MMM DD, YYYY"
                        )}
                      </h1>
                      <h1 className="flex-1 text-end me-4">{rating}/5</h1>
                    </div>
                  );
                })
              ) : (
        ...
        <div className="bg-[#EFEFEF] h-[100%] rounded-md overflow-hidden flex flex-col">
          ...
          {dataDetails && (
            <div className="overflow-auto h-[100%] px-4 py-4 space-y-5">
